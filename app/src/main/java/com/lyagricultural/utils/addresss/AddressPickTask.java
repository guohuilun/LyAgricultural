package com.lyagricultural.utils.addresss;
...
public class AddressPickTask extends AsyncTask<String, Void, ArrayList<Province>> {
    ...
    protected void onPostExecute(ArrayList<Province> result) {
        ...
        if (result.size() > 0) {
            ...
            picker.setTitleTextColor(Color.parseColor("#B7B7B7"));
            picker.setTitleTextSize(12);

            picker.setCancelTextColor(Color.parseColor("#77C34F"));
            picker.setSubmitTextColor(Color.parseColor("#77C34F"));
