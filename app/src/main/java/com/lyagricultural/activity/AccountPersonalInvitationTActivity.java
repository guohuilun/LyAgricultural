 ...
 */
public class AccountPersonalInvitationTActivity extends BaseActivity{
    private static final String TAG = "AccountPersonalInvitationTActivity";
    ...
    private void setMRecyclerAdapter(){
        ...
        mAccountRecyclerAdapter=new BaseRecyclerAdapter<AccountPersonalInvitationBean.UserinfoBean>
                (AccountPersonalInvitationTActivity.this,mAccountList,R.layout.ly_activity_account_personal_invitation_rv_item) {
            @Override
