 ...
 */
public class BreedHiveHarvestSuccessActivity extends BaseActivity implements View.OnClickListener,PlatformActionListener {
    private static final String TAG = "BreedHiveHarvestSuccessActivity";
    ...
    private void initView(){
        ...
        iv_default.setImageResource(R.drawable.ly_breed_hive_harvest_success);
        land_harvest_success_back_button.setText("返回蜂箱");
         userId = SpSimpleUtils.getSp("userid", BreedHiveHarvestSuccessActivity.this, "LoginActivity");
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.land_harvest_success_seed_out_button:
                startActivity(new Intent(BreedHiveHarvestSuccessActivity.this,AccountSeedOutActivity.class));
                finish();
                break;
